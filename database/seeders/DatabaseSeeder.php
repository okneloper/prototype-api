...
class DatabaseSeeder extends Seeder
{
    ...
    private function createUsers(): void
    {
        ...
        /* @var $user User */
        $user->createToken('default', ['orders-create'])->accessToken->update([
        ...
        $user->createToken('default', ['orders-list', 'orders-show'])->accessToken->update([
        ...
        $user->createToken('default', ['orders-show'])->accessToken->update([
